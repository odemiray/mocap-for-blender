...
IMPORT(CLEyeCameraInstance)
CLEyeCreateCamera(GUID camUUID, CLEyeCameraColorMode mode,
...
IMPORT(bool)
CLEyeCameraGetFrame(CLEyeCameraInstance cam, PBYTE pData, int waitTimeout = 2000);
